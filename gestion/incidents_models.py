...
class Incident(models.Model):
    ...
    creation_date = models.DateTimeField(default=tz.now(), verbose_name=_('Creado el'))
    closed_date = models.DateTimeField(default=datetime.datetime.max, blank=True, null=True, verbose_name=_('Cerrado el'))

    owner = models.ForeignKey(User, blank=False, null=False, verbose_name=_('Creada por'))
    type = models.ForeignKey(IncidentType, verbose_name = _('Tipo'), blank = False, null = True, related_name = 'incidents')
